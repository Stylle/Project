...
void ULN2003_Init()
{
	...
	GPIO_InitStructure.GPIO_Pin = ULN2003_PIN;  //设置指定IO口
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;  //设置速率
	GPIO_Init(ULN2003_GPIO_PORT,&GPIO_InitStructure);//端口选择
	GPIO_ResetBits(ULN2003_GPIO_PORT,ULN2003_PIN);//设置端口默认为高电平
}

...
void KEY4X4_Init(void)
{
	...
	GPIO_Initture.GPIO_Pin = KEY4X4_H_PIN;  //设置指定IO口
	GPIO_Initture.GPIO_Speed = GPIO_Speed_50MHz;  //设置速率
	GPIO_Init(KEY4X4_H_GPIO_PORT,&GPIO_Initture);//端口选择
	...
	GPIO_Initture.GPIO_Pin = KEY4X4_L_PIN;  //设置指定IO口
	GPIO_Initture.GPIO_Speed = GPIO_Speed_50MHz;  //设置速率
	GPIO_Init(KEY4X4_L_GPIO_PORT,&GPIO_Initture);//端口选择
